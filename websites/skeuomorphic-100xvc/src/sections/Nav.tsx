      ...
      <div className="mx-auto flex h-[62px] max-w-[1200px] items-center gap-4 px-5 sm:px-8">
        <a href="/" className="flex items-center gap-2.5">
          ...
          <span className="text-[15px] font-bold tracking-[-0.02em]">
            APP.100X<span className="text-ink-55">VC</span>.IO
          </span>
        </a>
        ...
        <nav className="ml-2 hidden items-center sm:flex">
          <a
            href="/expedition"
            className="group flex items-center gap-1 rounded-full px-3 py-1.5 text-[13.5px] font-medium text-ink-70 transition-colors hover:text-[hsl(var(--ink))]"
          >
            Expedition
